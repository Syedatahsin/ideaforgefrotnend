      ...
      <div className="max-w-7xl mx-auto mt-10">
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <motion.div 
            ...
            className="bg-slate-50 dark:bg-slate-900/50 p-8 md:p-12 rounded-3xl border border-slate-200 dark:border-slate-800 shadow-xl"
          >
            ...
            <form action="https://api.web3forms.com/submit" method="POST" className="space-y-6">
              ...
              <button 
                type="submit"
                className="w-full py-4 rounded-xl bg-gradient-to-r from-sky-500 to-indigo-600 hover:from-sky-600 hover:to-indigo-700 text-white font-bold shadow-lg shadow-sky-200 dark:shadow-none transition-all flex items-center justify-center gap-2 group"
              >
                Send Message
